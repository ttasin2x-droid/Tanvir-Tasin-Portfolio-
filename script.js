...
if (!localStorage.getItem('admin_bypass')) {
    ...
    // === UPDATED: Location & Device Info (Using ipwho.is) ===
    if (!sessionStorage.getItem('logged_device')) {
        // ipwho.is ব্যবহার করা হচ্ছে যা বেশি রিলায়েবল
        fetch('https://ipwho.is/')
            ...
            .then(data => {
                ...
                // ডাটা সফলভাবে এসেছে কিনা চেক করা
                ...
                push(ref(db, 'visit_logs'), {
                    ...
                    country_code: success ? data.country_code.toLowerCase() : 'bd', // ডিফল্ট ফ্ল্যাগ BD
            ...
            .catch(error => {
                // কোনো কারণে ফেইল করলে বেসিক লগ রাখা হবে
